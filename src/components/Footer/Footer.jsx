const Footer = () => {
    return (
        <footer className="relative bg-[#13172b] text-white py-8 md:py-16 mt-8 md:mt-[257px]">
            <div className="absolute -top-16 md:-top-32 left-1/2 transform -translate-x-1/2 w-11/12 md:w-1/2  bg-gradient-to-r from-[#f1e3e0] to-[#f4dcae] p-6 md:p-8 rounded-lg shadow-lg mt-7 ">
                ...
                <div className="flex justify-center space-x-2">
                    <input type="email" placeholder="Enter your email" className="w-3/4 p-3 rounded-lg " />
            ...
            <div className="container mx-auto flex flex-col md:flex-row justify-between items-start text-center md:text-left mt-16 md:mt-24 space-y-8 md:space-y-0 ">
                ...
                <div className="ml:0 md:ml-10 mb-8 md:mb-0 w-full md:w-1/3">
                ...
                <div className="w-full md:w-1/3 text-center mr-10">
